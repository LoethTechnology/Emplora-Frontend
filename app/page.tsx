  ...
  const renderFaqMenu = () => {
    switch (faqActiveMenu) {
      ...
      case "reviewsAndRatings":
        return (
          <FaqLoader
            faqActiveMenu="reviewsAndRatings"
            faqData={reviewAndRatings}
          />
        );
      ...
      case "privacyAndAnonymity":
        return (
          <FaqLoader
            faqActiveMenu="privacyAndAnonymity"
            faqData={privacyAndAnonymity}
          />
        );
      ...
      case "companyInformation":
        return (
          <FaqLoader
            faqActiveMenu="companyInformation"
            faqData={companyInformation}
          />
        );
        ...
        <header className="grid justify-center content-center items-center text-center mt-30 md:mt-40">
          ...
          <div className="mt-6 md:mt-2.5">
            ...
            <p className="text-[#727272] text-[20px] md:text-[20px] leading-relaxed md:leading-6.5 max-w-3xl mx-auto">
              Get honest reviews, real employee insights, and transparent
              ratings to help you make smarter career decisions.
            </p>
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-center text-center h-full">
            ...
            <div className="text-center lg:text-left">
              <p className="text-sm md:text-base leading-relaxed">
                Empowering job seekers with the information they need while
          ...
          <div className="grid justify-center items-center text-center px-4">
            ...
            <div className="max-w-5xl mx-auto">
              <h2 className="text-[26px] md:text-[40px] leading-tight md:leading-11.5 font-medium text-black">
                Explore 500+ Real{" "}
                <span className="text-[#334EAC]"> Employee Reviews </span>
          ...
          <div className="grid justify-center items-center text-center px-4">
            ...
            <div className="mb-4">
              <h1 className="text-center text-[20px] md:text-[20px] leading-7.5 text-[#727272]">
                Rate your experience and describe the work environment,
                management, salary <br />
        ...
        <section className="mt-32.5">
          <div className="grid items-center text-center px-4">
            ...
            <div className="max-w-5xl mx-auto">
              <h2 className="text-[26px] md:text-[40px] leading-tight md:leading-11.5 font-medium text-black">
                Frequently Asked{" "}
                <span className="text-[#334EAC]"> Questions </span>
              </h2>
            </div>

            {/* FAQ Container div */}
            <div
              className="px-2 py-3 md:px-3 w-full md:w-[55%] 
