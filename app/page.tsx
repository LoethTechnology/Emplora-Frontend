...
// Creating a function for rendering the faq questions and answer 
  ...
  return (
    <Fragment>
      ...
      {/* Adding the main div */}
      <main className="min-h-screen bg-white p-4 md:p-[30px] mb-37.5">
        {/* Header Div */}
          ...
          <div className="w-full flex flex-col justify-center">
            ...
            <div className="w-full lg:flex items-center">
              ...
              <div className="mt-[15px] lg:mt-0">
                <button className="md:w-[40%] w-full lg:w-auto text-[white] h-[50px] text-[15px] bg-[#334EAC] pl-[30px] pr-[30px] rounded-[5px] hover:bg-[#1e2e6b] transition-colors duration-1000 ease-in-out"> Search </button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mt-[130px]">
          <div className="grid items-center text-center px-4">
            ...
            <header className="mb-4">
              <h1 className="bg-[#ebedf7] text-center w-fit min-w-[80px] mx-auto px-4 py-2 rounded-full text-[#334eab] text-[12px] border border-[#334eab3b] font-medium uppercase tracking-wider">
                FAQ
              </h1>
            </header>
            ...
            {/* FAQ Container div */}
            <div className="px-2 py-3 md:px-3 w-full md:w-[55%] 
              grid grid-cols-1 sm:grid-cols-2 gap-2
              md:flex md:justify-between md:items-center md:gap-0
              mx-auto min-h-[40px] rounded-[6px] mt-[25px] md:mt-[45px] bg-[#f7f7f7]"
            >

              {/* Button */}
              <button
                className={`${faqActiveMenu === "home"
                  ? "bg-[#334EAC] text-white"
                  : "text-black"
                  } transition-all px-3 md:px-5 py-2 rounded-[6px] text-[12px] md:text-[14px] w-auto`}
              ...
              <button
                className={`${faqActiveMenu === "reviewsAndRatings"
                  ? "bg-[#334EAC] text-white"
                  : "text-black"
                  } transition-all px-3 md:px-5 py-2 rounded-[6px] text-[12px] md:text-[14px] w-auto`}
              ...
              <button
                className={`${faqActiveMenu === "privacyAndAnonymity"
                  ? "bg-[#334EAC] text-white"
                  : "text-black"
                  } transition-all px-3 md:px-5 py-2 rounded-[6px] text-[12px] md:text-[14px] w-auto`}
              ...
              <button
                className={`${faqActiveMenu === "companyInformation"
                  ? "bg-[#334EAC] text-white"
                  : "text-black"
                  } transition-all px-3 md:px-5 py-2 rounded-[6px] text-[12px] md:text-[14px] w-auto`}
            ...
            <div className="text-left md:w-[50%] mx-auto h-[300px] rounded-[6px] mt-[25px] md:mt-[45px"
            >
              {/* First reviews  */}
