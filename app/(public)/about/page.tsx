    ...
    <Fragment>
      <main>
        ...
        <div className="relative">
          {/* Adjusted the top margin/positioning so it sits behind the overlay navbar correctly */}
          <div className="relative h-96 flex items-center justify-center -mt-[80px]">
            <Image
              src={backdrop}
              alt="about backdrop"
              fill
            ...
            <div className="text-white z-10 text-center pt-28">
              <h1 className="font-semibold text-[50px]">About Us</h1>
