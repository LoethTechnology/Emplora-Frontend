    ...
    <Fragment>
      {faqKeys.map((question, index) => {
        ...
        return (
          <div
            key={index}
            className="bg-[#f7f7f7] p-5 rounded-[6px] mt-2.5 border border-solid border-[#49506936] cursor-pointer transition-all hover:bg-[#fdfdfd]"
          ...
          >
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ease-in-out ${
                isOpen ? "max-h-125 mt-4 opacity-100" : "max-h-0 opacity-0"
              }`}
            >
